...
This component library will be written in TypeScript, built using esbuild, and published to npm. At the end of this tutorial, you'll be able to install your libary like this:
